...
namespace CoreSdkExamples
{
    public partial class NightClubForm : VRForm
    {
        ...
        {
            var position = viewerSdk.CurrentActor.Position;
            ...
            spotLight.Position = new Vector3d(
                position.X + (Randomizer.NextDouble() - 0.5) * 20,
                position.Y + 5.0,
                position.Z + (Randomizer.NextDouble() - 0.5) * 20);
        }
